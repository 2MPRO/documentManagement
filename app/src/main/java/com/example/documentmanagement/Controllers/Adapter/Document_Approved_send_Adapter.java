...
public class Document_Approved_send_Adapter extends BaseAdapter {

    ArrayList<Document> documentArrayList,documentArrayListTMP;
    ApprovedSendFragment activity;
    String btn_action;
    public Document_Approved_send_Adapter(ArrayList<Document> documentArrayList, ApprovedSendFragment activity, String btn_action) {
    ...
    private void recall(String docNUm) {
        RequestQueue requestQueue = Volley.newRequestQueue(activity.getActivity());
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Server.LinkToRecall + "?docNum=" + docNUm,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        if(response.trim().equals("ok")){
                            Toast.makeText(activity.getActivity(),"Thu hồi thành công !",Toast.LENGTH_SHORT).show();
                            activity.loaddata();
                        }
                        else{
