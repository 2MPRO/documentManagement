...
public class Server {
    ...
    public static String LinkUpdateAccount = "http://" + localhost + "/phpcodeDocumentMNG/updateAccount.php" ;
    public static String LinkGetAccount = "http://" + localhost + "/phpcodeDocumentMNG/getAccount.php" ;
